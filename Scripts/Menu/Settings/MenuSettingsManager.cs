...
public class MenuSettingsManager : MonoBehaviour {
    ...
    void Start() {
        GameObject.Find("Canvas").GetComponent<FileManager>().openSettings();
    }

    // Update is called once per frame
    void Update() {
        GameObject.Find("Canvas").GetComponent<FileManager>().saveSettings(findInputedSettings());
    }

    settingsPackage findInputedSettings() {
